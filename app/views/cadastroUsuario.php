    ...
    <div class="container">
        ...
        <form action="index.php?c=usuario&a=inserir" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="endereco" class="form-control" id="endereco" placeholder="Digite o seu endereco" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="estado" class="form-control" id="estado" placeholder="Digite o seu estado" required>
            </div>
            <div class="form-group">
