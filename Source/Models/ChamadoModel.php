...
WHERE id = :id";
      $params = http_build_query([
        ...
        'anexo' => $this->data->anexo, // Novo campo anexo
        'id' => $this->data->id
      ]);
...
(descricao, localizacao, data_hora, status, usuario_id, anexo)
VALUES (:descricao, ST_GeomFromText(:localizacao), :data_hora, :status, :usuario_id, :anexo)";
      $params = http_build_query([
        'descricao' => $this->data->descricao,
        'localizacao' => $this->data->localizacao,
        'data_hora' => $this->data->data_hora,
